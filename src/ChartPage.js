...
export default class ChartPage extends Component {
    ...
    ctx4;
    ctx5;
    minimumdebi = (1 / this.state.ndegeri) * (Math.pow(this.minimumyaricap, (2 / 3))) * Math.pow(this.state.jdegeri, 1 / 2) * this.minimumalan;
    maksimumdebi = (1 / this.state.ndegeri) * (Math.pow(this.maksimumyaricap, (2 / 3))) * Math.pow(this.state.jdegeri, 1 / 2) * this.maksimumalan;
    ortalamadebi = (1 / this.state.ndegeri) * (Math.pow(this.ortalamayaricap, (2 / 3))) * Math.pow(this.state.jdegeri, 1 / 2) * this.ortalamaalan;
    myMap = new Map();
    mdegerli = new Map();
    ...
    crossmetodualan = (nextstate) => {
        ...
        for (let j = 1; j < minimumdizi.length - 1; j++) {
            if (minimumdizi[j].y >= 0) {
                ...
                let sonuc = minimumdizi[j].y * (minimumdizi[j - 1].x - minimumdizi[j + 1].x);
                cevaplar[0] += sonuc;
        ...
        if (minimumdizi[0].y < 0) {
            ...
            let sonuc = minimumdizi[0].y * (minimumdizi[minimumdizi.length - 1].x - minimumdizi[1].x);
        ...
        if (minimumdizi[minimumdizi.length - 1].y < 0) {
            ...
            cevaplar[0] -= minimumdizi[minimumdizi.length - 1].y * (minimumdizi[minimumdizi.length - 2].x - minimumdizi[0].x);
        } else {
        ...
        for (let j = 1; j < ortalamadizi.length - 1; j++) {
            if (ortalamadizi[j].y >= 0) {
                ...
                let sonuc = ortalamadizi[j].y * (ortalamadizi[j - 1].x - ortalamadizi[j + 1].x);
                cevaplar[1] += sonuc;
        ...
        if (ortalamadizi[0].y < 0) {
            ...
            let sonuc = ortalamadizi[0].y * (ortalamadizi[ortalamadizi.length - 1].x - ortalamadizi[1].x);
        ...
        if (ortalamadizi[ortalamadizi.length - 1].y < 0) {
            ...
            cevaplar[1] -= ortalamadizi[ortalamadizi.length - 1].y * (ortalamadizi[ortalamadizi.length - 2].x - ortalamadizi[0].x);
        } else {
        ...
        for (let j = 1; j < maksimumdizi.length - 1; j++) {
            if (maksimumdizi[j].y >= 0) {
                ...
                let sonuc = maksimumdizi[j].y * (maksimumdizi[j - 1].x - maksimumdizi[j + 1].x);
                cevaplar[2] += sonuc;
        ...
        if (maksimumdizi[0].y < 0) {
            ...
            let sonuc = maksimumdizi[0].y * (maksimumdizi[maksimumdizi.length - 1].x - maksimumdizi[1].x);
        ...
        if (maksimumdizi[maksimumdizi.length - 1].y < 0) {
            ...
            cevaplar[2] -= maksimumdizi[maksimumdizi.length - 1].y * (maksimumdizi[maksimumdizi.length - 2].x - maksimumdizi[0].x);
        } else {
    ...
    yaricap = () => {
        ...
        this.minimumyaricap = parseFloat(this.minimumalan / this.minimumislakcevre).toFixed(2);
        this.ortalamayaricap = parseFloat(this.ortalamaalan / this.ortalamaislakcevre).toFixed(2);
        this.maksimumyaricap = parseFloat(this.maksimumalan / this.maksimumislakcevre).toFixed(2);
    };
    debihesabi = (nextstate) => {
        ...
        this.minimumdebi = (1 / nextstate.ndegeri) * (Math.pow(this.minimumyaricap, (2 / 3))) * Math.pow(nextstate.jdegeri, 1 / 2) * this.minimumalan;
        this.maksimumdebi = (1 / nextstate.ndegeri) * (Math.pow(this.maksimumyaricap, (2 / 3))) * Math.pow(nextstate.jdegeri, 1 / 2) * this.maksimumalan;
        this.ortalamadebi = (1 / nextstate.ndegeri) * (Math.pow(this.ortalamayaricap, (2 / 3))) * Math.pow(nextstate.jdegeri, 1 / 2) * this.ortalamaalan;
    };
    ...
    islakcevrefounder = (nextState) => {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            while (this.charts[i][0].y < this.data1[starting].y)
                starting++;

            const startingyedek = starting;
            while (this.charts[i][0].y > this.data1[starting + 1].y) {

                this.islakcevre[i] += Math.sqrt((Math.pow(this.data1[starting].x - this.data1[starting + 1].x, 2)) + (Math.pow(this.data1[starting].y - this.data1[starting + 1].y, 2)));

                starting++;
            }

            this.islakcevre[i] += Math.sqrt((Math.pow(this.data1[startingyedek].x - this.charts[i][0].x, 2)) + (Math.pow(this.data1[startingyedek].y - this.charts[i][0].y, 2)));

            this.islakcevre[i] += Math.sqrt((Math.pow(this.data1[starting].x - this.charts[i][1].x, 2)) + (Math.pow(this.data1[starting].y - this.charts[i][1].y, 2)));
        }
    ...
    constructor(props) {
        ...
        this.myMap.set(0.029, "(1) Enkesit tabanı oldukça muntazam, sahilleri düz ve sağlam, hiç bitki örtüsü yok");
        this.myMap.set(0.031, "(2) 1. gibi , bununlar beraber sahili bitki örtüsü ile kaplı");
        this.myMap.set(0.033, "(3) Enkesitleri oldukça gayri muazzam, birkaç sahili kaymış,oyulmalar ve birikintiler mevcut");
        this.myMap.set(0.035, "(4) 2.gibi, fakat kuvvetli sahil kaymaları, oyuntular ve yığıntılar mevcut");
        this.myMap.set(0.045, "(5) 3. gibi, bununla beraber tabanda ve sahilde bitki mevcut");
        this.myMap.set(0.060, "(6) Vahşi,derin oyulmalar, büyük taşlar ve kuvvetli sahil kaymaları mevcut");
        ...
        for (let i = this.state.hdegeri; i <= 3.02; i += 0.02) {
            this.kaplamasizzemintablo.push({ h: parseFloat(hsondeger).toFixed(2), b: Math.round(5 * hsondeger) });
            hsondeger += 0.02;
        }

        for (let i = 0; i < this.kaplamasizzemintablo.length; i++) {
            this.kaplamasizzemintablo[i].alan = parseFloat((this.kaplamasizzemintablo[i].h *
                this.kaplamasizzemintablo[i].b) + (this.state.mdegeri * (Math.pow(this.kaplamasizzemintablo[i].h, 2)))).toFixed(2);

        }
        for (let i = 0; i < this.kaplamasizzemintablo.length; i++) {
            this.kaplamasizzemintablo[i].cevre = parseFloat(this.kaplamasizzemintablo[i].b + (2 * this.kaplamasizzemintablo[i].h * (Math.sqrt(1 + (Math.pow(this.state.mdegeri, 2)))))).toFixed(2);
        }
        for (let i = 0; i < this.kaplamasizzemintablo.length; i++) {
            this.kaplamasizzemintablo[i].R = parseFloat(this.kaplamasizzemintablo[i].alan / this.kaplamasizzemintablo[i].cevre).toFixed(2);
        }
        this.isale_n_degerleri.set(0.040, "Gevşek zemin");
        ...
        for (let i = 0; i < this.kaplamasizzemintablo.length; i++) {
            let rikiboluuc = Math.pow(this.kaplamasizzemintablo[i].R, (2 / 3)) * this.kaplamasizzemintablo[i].alan;
        ...
        for (let i = 0; i < this.kaplamasizzemintablo.length; i++) {
            this.kaplamasizzemintablo[i].kabartmakotu = parseFloat(this.state.kanalinsonundakisuyuzukotu +
                (this.kaplamasizzemintablo[i].j * this.state.isalekanaliuzunlugu) + 0.5).toFixed(2);
        }

        for (let i = 0; i < this.kaplamasizzemintablo.length; i++) {
            this.kaplamasizzemintablo[i].kk_esk = parseFloat(this.kaplamasizzemintablo[i].kabartmakotu - this.state.eselsifirkotu).toFixed(2);
        }

        // KAPLAMALI KANAL
        hsondeger = 1;
        for (let i = this.state.hdegeri; i <= 3.02; i += 0.02) {
            this.kaplamalikanal.push({ h: parseFloat(hsondeger).toFixed(2), b: Math.round(5 * hsondeger) });
            hsondeger += 0.02;
        }

        for (let i = 0; i < this.kaplamalikanal.length; i++) {
            this.kaplamalikanal[i].alan = parseFloat((this.kaplamalikanal[i].h *
                this.kaplamalikanal[i].b) + (this.state.kaplamalimdegeri * (Math.pow(this.kaplamasizzemintablo[i].h, 2)))).toFixed(2);

        }
        for (let i = 0; i < this.kaplamalikanal.length; i++) {
            this.kaplamalikanal[i].cevre = parseFloat(this.kaplamalikanal[i].b + (2 * this.kaplamalikanal[i].h * (Math.sqrt(1 + (Math.pow(this.state.kaplamalimdegeri, 2)))))).toFixed(2);
        }
        for (let i = 0; i < this.kaplamalikanal.length; i++) {
            this.kaplamalikanal[i].R = parseFloat(this.kaplamalikanal[i].alan / this.kaplamalikanal[i].cevre).toFixed(2);
        }
        let qisale2 = qisale * this.state.kaplamalindegeri;
        for (let i = 0; i < this.kaplamalikanal.length; i++) {
            let rikiboluuc = Math.pow(this.kaplamalikanal[i].R, (2 / 3)) * this.kaplamalikanal[i].alan;
        ...
        for (let i = 0; i < this.kaplamalikanal.length; i++) {
            this.kaplamalikanal[i].hiz = parseFloat(qisale / this.kaplamalikanal[i].alan).toFixed(4);
        }

        for (let i = 0; i < this.kaplamalikanal.length; i++) {
            this.kaplamalikanal[i].kabartmakotu = parseFloat(this.state.kanalinsonundakisuyuzukotu +
                (this.kaplamalikanal[i].j * this.state.isalekanaliuzunlugu) + 0.5).toFixed(2);
        }

        for (let i = 0; i < this.kaplamalikanal.length; i++) {
            this.kaplamalikanal[i].kk_esk = parseFloat(this.kaplamalikanal[i].kabartmakotu - this.state.eselsifirkotu).toFixed(2);
        }
        ...
        let alinanj;
        for (let i = 0; i < this.kaplamasizzemintablo.length; i++) {
            if (this.kaplamasizzemintablo[i].kk_esk > 4 && this.kaplamasizzemintablo[i].kk_esk < 6)
        ...
        let kaplamsizto = this.state.gamasu * alinanr * alinanj
    ...
    render() {
        console.log("tablonun son hali");
        console.log(this.kaplamasizzemintablo);
        return (<div className="App">

            <TextField id="standard-number" label="X KATSAYISI" value={this.state.x}
                onChange={this.handlechange('x')} type="number" className={"x"} InputLabelProps={{
                    shrink: true
                }} margin="normal" />
            <TextField id="standard-number" style={{
                fontSize: "26px"
            }} label="Y KATSAYISI" value={this.state.y} onChange={this.handlechange('y')} type="number"
                className={"y"} InputLabelProps={{
                    shrink: true
                }} margin="normal" /><br />
            <TextField id="standard-number" style={{
                fontSize: "26px"
            }} label="Minimum" value={this.state.minimum} onChange={this.handlechange('minimum')} type="number"
                className={"y"} InputLabelProps={{
                    shrink: true
                }} margin="normal" />
            <TextField id="standard-number" style={{
                fontSize: "26px"
            }} label="Ortalama" value={this.state.ortalama} onChange={this.handlechange('ortalama')}
                type="number"
                className={"y"} InputLabelProps={{
                    shrink: true
                }} margin="normal" />
            <TextField id="standard-number" style={{
                fontSize: "26px"
            }} label="Maksimum" value={this.state.maksimum} onChange={this.handlechange('maksimum')}
                type="number"
                className={"y"} InputLabelProps={{
                    shrink: true
                }} margin="normal" />
            ...
            <Container>
                ...
                <Row>
                    <Col>
                        <p className="bg-primary text-white">Minimum Çevre
                        </p>

                    </Col>
                    <Col>
                        <p className="bg-primary text-white">{this.minimumislakcevre + "m"}</p>
                    </Col>
                </Row>
                <Row>
                    <Col>
                    ...
                    <Col>
                        <p className="bg-primary text-white ">{this.ortalamaislakcevre + "m"}</p>
                    </Col>
                </Row>
                <Row>
                    <Col>
                    ...
                    <Col>
                        <p className="bg-primary text-white">{this.maksimumislakcevre + "m"}</p>
                    </Col>
                </Row>
                <Row></Row>
                <Row>
                ...
                <Row>
                    <Col>
                        <p className="bg-primary text-white">Minimum Alan
                        </p>
                ...
                <Row>
                    ...
                    <Col>
                        <p className="bg-primary text-white ">{this.ortalamaalan + "m²"}</p>
                    </Col>
                </Row>
                <Row>
                    <Col>
                    ...
                    <Col>
                        <p className="bg-primary text-white">{this.maksimumalan + "m²"}</p>
                    </Col>
                </Row>
                <Row></Row>
                <Row>
                    <Col>
                        <div className="p-3 mb-2 bg-danger text-white">Yarıçap Hesabı</div>

                    </Col>
                </Row>
                <Row>
                    <Col>
                        <p className="bg-primary text-white">Minimum Yarıçap
                        </p>

                    </Col>
                    <Col>
                        <p className="bg-primary text-white">{parseFloat(this.minimumyaricap).toFixed(2) + "m"}</p>
                    </Col>
                </Row>
                <Row>
                    <Col>
                    ...
                    <Col>
                        <p className="bg-primary text-white ">{parseFloat(this.ortalamayaricap).toFixed(2) + "m"}</p>
                    </Col>
                </Row>
                <Row>
                    <Col>
                    ...
                    <Col>
                        <p className="bg-primary text-white">{parseFloat(this.maksimumyaricap).toFixed(2) + "m"}</p>
                    </Col>
                </Row>
            ...
            <Container>
                <Row>
                    <Col>
                        ...
                        <br></br>
                        <select value={this.state.ndegeri} className="browser-default custom-select"
                        ...
                        <br></br>
                        <h5 className={"text-success"} id={"hadibe"}>{this.myMap.get(this.state.ndegeri)}</h5>
                    </Col>
                ...
                <Row>
                    <Col>
                        ...
                        <br></br>
                        <select value={this.state.jdegeri} className="browser-default custom-select"
                ...
                <Row>
                    <Col>
                        <p className="bg-primary text-white">Minimum Debi
                        </p>

                    </Col>
                    <Col>
                        <p className="bg-primary text-white">{parseFloat(this.minimumdebi).toFixed(2) + "m"}</p>
                    </Col>
                </Row>
                <Row>
                    <Col>
                    ...
                    <Col>
                        <p className="bg-primary text-white ">{parseFloat(this.ortalamadebi).toFixed(2) + "m"}</p>
                    </Col>
                </Row>
                <Row>
                    <Col>
                    ...
                    <Col>
                        <p className="bg-primary text-white">{parseFloat(this.maksimumdebi).toFixed(2) + "m"}</p>
                    </Col>
                </Row>
                <Row>
                    <Col>
                        <div className="p-3 mb-2 bg-danger text-white">Yükseklik Hesabı</div>

                    </Col>
                </Row>
                <Row>
                    <Col>
                        <p className="bg-primary text-white">Minumum Yükseklik
                        </p>

                    </Col>
                    <Col>
                        <p className="bg-primary text-white">{parseFloat(this.minimumyukseklik).toFixed(2) + "m"}</p>
                    </Col>
                </Row>
                <Row>
                    <Col>
                    ...
                    <Col>
                        <p className="bg-primary text-white ">{parseFloat(this.ortalamayukseklik).toFixed(2) + "m"}</p>
                    </Col>
                </Row>
                <Row>
                    <Col>
                    ...
                    <Col>
                        <p className="bg-primary text-white"> {parseFloat(this.maksimumyukseklik).toFixed(2) + "m"}</p>
                    </Col>
                </Row>

            </Container>
            <div className="myChartdiv23">
                <canvas id="myChart2" width="1300px" height="700px"></canvas>
            </div>

            <div className="myChartdiv24">
                <canvas id="myChart3" width="1300px" height="700px"></canvas>
            </div>

            <div className="myChartdiv25">
                <canvas id="myChart4" width="1300px" height="700px"></canvas>
            </div>

            <div className="myChartdiv26">
                <canvas id="myChart5" width="1300px" height="700px"></canvas>
            </div>
            <TextField id="standard-number" label="a değeri" value={this.state.adegeri}
                onChange={this.handlechange('adegeri')} type="number" className={"x"} InputLabelProps={{
                    shrink: true
                }} margin="normal" />
            <TextField id="standard-number" label="h katsayısı" value={this.state.hdegeri}
                onChange={this.handlechange('hdegeri')} type="number" className={"x"} InputLabelProps={{
                    shrink: true
                }} margin="normal" />

            <Container><Col>
                <h4 className={"text-warning"}>Kaplamasız kanal için m değerleri</h4>
            </Col>
                <Row>

                    <select value={this.state.mdegeri} className="browser-default custom-select"
            ...
            <h5 className={"text-success"}>{this.mdegerli.get(this.state.mdegeri)}</h5>


            <Container><Col>
                <h4 className={"text-warning"}>Kaplamasız kanal için n değerleri</h4>
            </Col>
                <Row>

                    <select value={this.state.ndegeriisale} className="browser-default custom-select"
                    ...
                    <Col>
                        <h4 className={"text-success"}>{this.isale_n_degerleri.get(this.state.ndegeriisale)}</h4>
                    </Col>
                </Row>
            </Container>

            <Container><Col>
                <h4 className={"text-warning"}>Kaplamasız kanaliçin eşel sıfır kotu</h4>
            </Col>
                <Row>

                    <select value={this.state.eselsifirkotu} className="browser-default custom-select"
            ...
            <Container>
                ...
                <Row>
                    ...
                    <select value={this.state.isalekanaliuzunlugu} className="browser-default custom-select"
